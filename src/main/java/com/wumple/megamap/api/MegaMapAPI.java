...
public class MegaMapAPI implements IMegaMapAPI
{
	...
	{
		return ItemTags.getCollection().getOrCreate(new ResourceLocation("megamap", "megamap_empty")).contains(itemstack1.getItem());
	}

	@Override
	public boolean isFilledMap(ItemStack itemstack1)
	{
		return ItemTags.getCollection().getOrCreate(new ResourceLocation("megamap", "megamap_filled")).contains(itemstack1.getItem());
	}
